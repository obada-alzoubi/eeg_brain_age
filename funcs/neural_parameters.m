...
%---------------------------------------------------------------------
LP_fc='XX';  % low-pass filter cut-off
Fs_new='xx'; % down-sample to Fs_new (Hz)
...
% or 
% $$$ 
BI_MONT={{'F4','P4'},{'F3','P3'}, {'F4','CP6'},{'F3','CP5'}, ...
    {'F3', 'F4', 'P3', 'P4'}, {'F3', 'F4', 'CP5', 'CP6'}};
...
FREQ_BANDS=[0.5 4; 4 7; 8 13; 15 30; 30 40]; 
%FREQ_BANDS=[0.5 4]; 
%s δ (14 Hz), θ (47 Hz), α/μ (813 Hz), β (beta, 1530 Hz), γ (gamma, 3080 Hz) 
%FREQ_BANDS =[0.5 4;4 8;8 10;10 13;13 20;20 30;30 48];
